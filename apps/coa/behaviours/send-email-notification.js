...
const getPersonalisation = (recipientType, req) => {
  const basePersonalisation = {
    ...
    leg_rep_address: req.sessionModel.get('steps').includes('/legal-details') ? req.sessionModel.get('legalAddressDetails') : '',
    ...
    new_home_address: req.sessionModel.get('steps').includes('/home-address') ?  req.sessionModel.get('addressDetails') : '',
    has_new_postal_address: req.sessionModel.get('steps').includes('/postal-address') ? 'yes' : 'no',
    new_postal_address: req.sessionModel.get('steps').includes('/postal-address') ? req.sessionModel.get('postalAddressDetails') : '',
