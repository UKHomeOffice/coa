...
TOKEN_RESPONSE=$(curl -sS -X POST -H "Authorization: Bearer ${UNSIGNED_TOKEN}.${SIGNATURE_B64}" -H "Accept: application/vnd.github+json" "https://api.github.com/app/installations/${INSTALLATION_ID}/access_tokens")
